...
import emailVerifyIcon from '../../images/icon/email_verify_icon.svg';
import { useDispatch } from 'react-redux';
import { loginThroughVerification } from '../../reducers/userSlice.js';
...
const VerifyEmailRegistration = () => {
    ...
    const handleResendOtp = async () => {
        ...
        try {
            const response = await apiPOST(`/admin/resend-otp`, userDetails);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        const userDetails = { token, otp: otp.join(''), email }
        try {
            await dispatch(loginThroughVerification(userDetails)).unwrap();
            navigate('/dashboard');
