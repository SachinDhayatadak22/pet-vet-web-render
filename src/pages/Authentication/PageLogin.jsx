                    ...
                    {mode!=="admin"?(
                      <>
                          <div className="relative flex items-center justify-center w-full pb-[45px] pt-[35px]">
                              <button
                                className={`absolute left-[15px] w-1/2 py-[10px] text-center text-[14px] font-medium rounded-full transition-all duration-300 ${
                                  role === "vet"
                              ...
                              <button
                                className={`absolute right-[15px] w-1/2 py-[10px] text-center text-[14px] font-medium rounded-full transition-all duration-300 ${
                                  role === "nurse"
                                    ? "bg-secondary text-white z-10"
                                    : "text-textTertiary z-0 bg-primary"
                                }`}
